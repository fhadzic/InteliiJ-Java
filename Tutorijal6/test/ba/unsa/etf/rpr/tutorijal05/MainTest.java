...
class MainTest {
    ...
    @Test
    public void number123buttonPercent (FxRobot robot) {
        display = robot.lookup("#display").queryAs(Label.class);
        robot.clickOn("#btn1");
        robot.clickOn("#btn2");
        robot.clickOn("#btn3");
        robot.clickOn("#buttonPercent");
        assertEquals("1.23", display.getText());
    }

    @Test
    public void number15buttonDivide6 (FxRobot robot) {
        display = robot.lookup("#display").queryAs(Label.class);
        robot.clickOn("#btn1");
        robot.clickOn("#btn5");
    ...
    @Test
    public void numberbuttonMultiple (FxRobot robot) {
        display = robot.lookup("#display").queryAs(Label.class);
        robot.clickOn("#btn1");
        robot.clickOn("#btn5");
        robot.clickOn("#dotBtn");
        robot.clickOn("#btn6");
        robot.clickOn("#buttonMultiple");
        robot.clickOn("#btn6");
        robot.clickOn("#dotBtn");
        robot.clickOn("#btn7");
        robot.clickOn("#equalsBtn");
        assertEquals("104.52", display.getText());
    }

    @Test
    public void numberbuttonDecrease (FxRobot robot) {
        display = robot.lookup("#display").queryAs(Label.class);
        robot.clickOn("#btn1");
        robot.clickOn("#btn5");
        robot.clickOn("#btn6");
        robot.clickOn("#buttonDecrease");
        robot.clickOn("#btn6");
        robot.clickOn("#btn7");
        robot.clickOn("#equalsBtn");
        assertEquals("89.0", display.getText());
    }
