...
public class Main {
    ...
    private static void unosArtikalaUMarket() throws IllegalAccessException {
    ...
    public static void ispisArtikala(Artikl[] artikli, int brojArtikala){
        for (int i=0; i<brojArtikala; i++) {
            if(artikli[i] != null) System.out.println("Naziv: " + artikli[i].getNaziv() + ", Kod: " + artikli[i].getKod() + ", Cijena: " + artikli[i].getCijena() + " KM");
        }
    }
...
//      unesena negativna, odnosno dovoljna suma novca.
        ...
        for(;;){
            ...
            if(opcija == 0){
                ...
                ispisArtikala(supermarket.getArtikli(), supermarket.getBrojArtikala());
                ...
                ispisArtikala(korpa.getArtikli(), korpa.getBrojArtikala());
                System.out.println("Unesite kod artikla (unesite malo slovo \"c\" za odustajanje): ");
                String kod = scanner.nextLine();
                kod = scanner.nextLine();
                if(!kod.equals("c")){
