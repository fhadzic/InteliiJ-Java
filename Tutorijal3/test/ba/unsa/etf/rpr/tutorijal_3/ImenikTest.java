...
import static ba.unsa.etf.rpr.tutorijal_3.Grad.BIHAC;
...
public class ImenikTest {
    ...
    @Test
    void istaImenaKontakata() {
        Imenik imenik = new Imenik();
        imenik.dodaj("John Smith", new MedunarodniBroj("+1", "23 45-67-89"));
        imenik.dodaj("Hana Hanic", new FiksniBroj(SARAJEVO, "123-156"));
        imenik.dodaj("John Smith", new FiksniBroj(SARAJEVO, "123-456"));
        imenik.dodaj("John Smith", new FiksniBroj(BIHAC, "123-156"));
        assertEquals(4, imenik.duzinaImenika());
    }
    ...
    void dajIme(){
        Imenik imenik = new Imenik();
        imenik.dodaj("John Smith", new MedunarodniBroj("+1", "23 45-67-89"));
        TelefonskiBroj brojHanin = new FiksniBroj(SARAJEVO, "123-156");
        imenik.dodaj("Hana Hanic", brojHanin);
        imenik.dodaj("Meho Mehic", new FiksniBroj(SARAJEVO, "123-456"));
        assertEquals("Hana Hanic", imenik.dajIme(brojHanin));
    }
